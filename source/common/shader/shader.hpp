...
namespace our {
    ...
    public:
        ...
        // Answer:
        // program is int id point to GPU Object so if we have copy or assignment operator 
        // then poth shader objects will point to the same GPU object 
        // so if one of them is destroyed the other one will not be able to use the GPU object
        // and it will cause a double free error so we should prevent that 
